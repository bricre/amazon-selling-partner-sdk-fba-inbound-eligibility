# (Unofficial) Amazon Selling Partner API client (PHP) - Selling Partner API for FBA Inbound Eligibilty
...
```shell
composer require bricre/amazon-selling-partner-sdk-fba-inbound-eligibility
```
...
```php
<?php
use Amz\FbaInboundEligibility\ResponseTypes;
